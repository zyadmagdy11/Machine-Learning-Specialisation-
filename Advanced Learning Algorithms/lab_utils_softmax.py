...
def plt_softmax(my_softmax):
    ...
    axz1 = fig.add_axes([0.30, 0.15, 0.30, 0.03])
    axz2 = fig.add_axes([0.60, 0.20, 0.30, 0.03])
    axz3 = fig.add_axes([0.20, 0.25, 0.30, 0.03])
    ...
    bar = ax[0].barh(z, height=0.3, width=[z0.val,z1.val,z2.val,z3.val], left=None, align='center')
    ...
    sbar = ax[1].barh(anames, height=0.3, width=a, left=None, align='center',color=dlc["dldarkred"])
